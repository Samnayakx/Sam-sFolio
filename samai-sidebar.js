(function () {
  ...
  function injectStyles() {
    ...
    style.textContent = [
      ...
      '.samai-head-name{',
        'font:600 11px/1 "Creato Display",-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;',
        'letter-spacing:0.13em;text-transform:uppercase;color:#f6f0e6;',
        'margin:0;white-space:nowrap;',
      '}',
      '.samai-head-ctx{',
        'font:11px/1 "Creato Display",-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;',
      ...
      '.samai-bubble{',
        'font:13px/1.6 "Creato Display",-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;',
      ...
      '.samai-input{',
        ...
        'font:13px "Creato Display",-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;',
